<h1 align="center">HOTEL SHILLA</h1>
<h3 align="center">
 호텔신라 웹페이지 리뉴얼
</h3>
<p align="center">
...
- 기술 스택: Java, OracleDB, Apache Tomcat
...
- 로그인: 입력한 값을 바탕으로 DB에서 회원 정보 검색하여 로그인 구현
- 게시판 1: 로그인 계정이 admin인 경우, CRUD 구현을 위한 기능 표시(글 등록, 수정, 삭제)
- 게시판 2: 검색창에 키워드 검색시 DB에 저장된 값 중 일치하는 게시물 목록 표시
