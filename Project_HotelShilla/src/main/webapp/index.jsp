...
<head>
    ...
    <titl e>The Shilla Hotels & Resorts</title>
                    ...
                    <div class="main_slide_txt w1200">
                        ...
                        <div>
                            <div class="main_txt">
                                ...
                                <button><a href="./ready.html">패키지 바로가기 &rarr;</a></button>
                        </div>
                    </div>
                </li>
            <!-- A-2. 슬라이드 될 각각 내용들 -->
                <li>
                    ...
                    <div class="main_slide_txt w1200">
                        ...
                        <div>
                            ...
                            <button>
                                <a href="./ready.html">패키지 바로가기 &rarr;
                                </a>
                            </button>
                        </div>
                    </div>
                ...
                <ul class="main_offer_top">
                    <li>
                        <a href="./promotion.html">
                            ...
                            <button><a href="./promotion.html">더보기</a></button>
                        ...
                        <section class="right_contents">
                            ...
                            <div class="right_contents_bottom">
                                <p class="room_main_text">
                                    ...
                                    <button><a href="./ready.html">더보기</a></button>
                                </p>
                ...
                <div class="w1200">
                    <div class="main_news_left">
                        <div class="main_news_content">
                            ...
                            <button><a href="./ready.html">구독 신청하기</a></button>
                        </div>
                    </div>
                    <div class="main_news_right">
                        <div class="main_news_content">
                            ...
                            <button><a href="./ready.html">자세히 보기</a></button>
                        </div>
                    </div>
                </div>
            </section>
